...
const models: ModelDefinition[] = [
  ...
  { key: "google-gemini-3.7-flash", id: "gemini-3.7-flash", provider: "google", label: "Gemini 3.7 Flash", contextWindow: 1_000_000, maxOutputTokens: 65_536, enabled: true }
];
...
describe("benchmark routing", () => {
  ...
  it("selects the long-context leader", () => expect(routePrompt("Summarize this", models, 40_000).modelKey).toBe("google-gemini-3.7-flash"));
